...
export default function Dashboard() {
  ...
  // -----------------------------------------------------------
  // ⭐ Load Once + Auto Refresh Every 5 Seconds
  // -----------------------------------------------------------
  useEffect(() => {
    // Load immediately
    fetchDashboardData();
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        ...
        <div className="bg-gray-100 rounded-xl p-5 flex flex-col justify-between">
          <div>
            ...
            <h2 className="text-lg font-semibold text-gray-800 mt-1">System Health</h2>
            ...
            <table className="w-full text-sm text-gray-700">
              ...
              <tbody>
                {alerts.slice(0, 3).map((a, i) => (
                  <tr key={i} className="border-b hover:bg-gray-200/40">
